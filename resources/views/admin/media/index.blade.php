                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between g-3">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Gallareyalar</h3>
                        </div>
                        <div class="nk-block-head-content">
                            <div class="dropdown mr-2">
                                <a class="btn btn-primary btn-lg dropdown-toggle" href="#" data-bs-toggle="dropdown" aria-expanded="false">Turkumlar</a>
                                <div class="dropdown-menu" style="">
                                    <ul class="link-list-opt">
                                        @foreach($categories as $category)
                                        <li><a href="{{route('categoryforGallery',['name' => $category->title_uz])}}"><span>{{$category->title_uz}}</span></a></li>
                                        @endforeach
                                    </ul>
                                </div>
                            </div>

                            <button  class="btn btn-outline-primary btn-lg" data-bs-toggle="modal" data-bs-target="#modalForm"><span>Qo'shish</span></button>
