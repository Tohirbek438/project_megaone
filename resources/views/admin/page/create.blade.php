...
@section('content')
    <div class="nk-content ">
        <form action="{{route('page.store')}}" data-select2-id="14" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="nk-content-body" data-select2-id="19">
                        <div class="nk-block-head nk-block-head-sm">
                            <div class="nk-block-between">
                                <div class="nk-block-head-content"><h3 class="nk-block-title page-title">Sahifa qo'shish</h3>
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <div class="tab-content">
                                                        <div class="tab-pane active" id="tabItem1" role="tabpanel">
                                                            <div class="row g-gs">
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group"><label class="form-label" for="addTitle">Sarlavha</label>
                                                                        <input
                                                                            type="text" class="form-control" name="title_uz"
                                                                            id="addTitle"
                                                        ...
                                                        <div class="tab-pane" id="tabItem2" role="tabpanel">
                                                            <div class="row g-gs">
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group"><label class="form-label"
                                                                                                   for="addTitle">Nomi
                                                                            ru </label><input type="text" class="form-control"
                                                                            name="name_ru" id="addTitle"
                                                                            placeholder="Nomi rus tilida"></div>
                                                                </div>
                                                                <div class="col-12">
                                                                    <div class="form-group"><label class="form-label"
                                        ...
                                        <div class="card-inner" data-select2-id="15">
                                            ...
                                            <div class="row g-gs" data-select2-id="13">
                                                <div class="col-lg-12 col-sm-6">
                                                    <div class="form-group"><label class="form-label"
                                                                                   for="addTags">Tags</label><input type="text" class="form-control" id="addTags" name="tags"
                                                            placeholder="Tags">
                                                    </div>
                                                    @error('tags')
                                                    <span class="text-danger">{{$message}}</span>
