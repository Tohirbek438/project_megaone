    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('menu.store')}}" class="form-validate is-alter" enctype="multipart/form-data" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="form-control-wrap">
                                <input required type="text" class="form-control" id="email-address" name="name_eng" placeholder="Enter your name in English">
                            </div>
                        </div>
                    </div>
