    ...
    <div class="nk-block nk-block-lg col-lg-11 mx-4 my-2">
        <div class="nk-block-head">
            <div class="nk-block-head-content">
                <h4 class="title nk-block-title">Tahrirlash</h4>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tabItem1" role="tabpanel">
                                <div class="row gy-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" id="default-01" name="title_uz"
                                                       placeholder="Sarlavha kiriting" value="{{$blog->title_uz}}">
                                                <br>
                                                @error('title_uz')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="text" class="form-control" id="default-05" name="writer_by"
                                                       placeholder="Input placeholder" value="{{$blog->writer_by}}">
                                                <br>
                                                @error('writer_by')
                                                <span class="text-danger">{{$message}}</span>
                                                @enderror
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label class="form-label" for="default-textarea">Tavsif uz</label>
                                            <div class="form-control-wrap">
                                            <textarea name="description_uz" class="form-control no-resize"
                                                      id="default-textarea">{{$blog->description_uz}}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control" id="default-01" name="title_ru"
                                                   placeholder="Sarlavha kiriting ru" value="{{$blog->title_ru}}">
                                            <br>
                                            @error('title_ru')
                                            <span class="text-danger">{{$message}}</span>
                                            @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <textarea name="description_ru" class="form-control no-resize"
                                                      id="default-textarea">{{$blog->description_ru}}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control" id="default-01" name="title_eng"
                                                   placeholder="Sarlavha kiriting eng" value="{{$blog->title_en}}">
                                            <br>
                                            @error('title_eng')
                                            <span class="text-danger">{{$message}}</span>
                                            @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <textarea name="description_eng" class="form-control no-resize"
                                                      id="default-textarea">{{$blog->description_en}}</textarea>
