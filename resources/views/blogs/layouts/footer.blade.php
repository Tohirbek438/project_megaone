    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <p class="company-about fadeIn theme-dark text-capitalize">&copy; 2023 MegaOne. Made With Love By <a class="theme-dark" href="javascript:void(0);">Themesindustry</a></p>
            </div>
        </div>
    </div>
</section>
