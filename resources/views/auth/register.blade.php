...
<form action="{{route('register')}}" method="POST">
    ...
    <h3>Register Here</h3>
    <br>
    <label for="username">F.I.SH</label>
    <input name="name" required  type="text" placeholder="Email or Phone" id="username">
    @error('email')
    ...
    <input type="password" required name="password_confirmation" placeholder="Password" id="password">
